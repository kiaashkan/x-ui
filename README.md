...
```
bash <(curl -Ls https://raw.githubusercontent.com/kiaashkan/x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/kiaashkan/x-ui/master/install.sh) v2.0.2
```
